...
final class TabBarController: UITabBarController {
    ...
    private func configureTabBarController() {
        ...
        firstNav.view.backgroundColor = ColorList.black
        ...
        secondNav.view.backgroundColor = ColorList.black
        ...
        thridNav.view.backgroundColor = ColorList.black
    ...
    private func configureApperance() {
        ...
        tabBarApperance.selectionIndicatorTintColor = ColorList.main
