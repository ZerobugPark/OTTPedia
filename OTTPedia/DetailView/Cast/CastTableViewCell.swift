...
//        collectionView.constant
    ...
    override func configureLayout() {
        ...
        collectionView.snp.makeConstraints { make in
           ...
           // make.height.equalTo(contentView.snp.width).multipliedBy(1.0 / 2.5)
    ...
    private func createCollectionViewLayout() -> UICollectionViewLayout {
        ...
        // 60 = Label Height(20) + offset(16) + inset(16) + spacing(8)
        let objectHeight = ((UIScreen.main.bounds.size.width / 2.5) - 60) / 2 // 레이블높이(20)
        print(objectHeight)
